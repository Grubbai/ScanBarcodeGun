...
u16 VirtAddVarTab[NumbOfVar] = {0x0001,0x0002,0x000A,0x000B,0x0014,0x00019,0x001A,0x001B,0x001C,
  							0x000a,0x000b,0x000c,0x000d,0x000e,0x000f,0x0010,0x0011,0x0012,0x0013,0x0014};
//[0]前缀长度区
//[1]前缀数据区
//[2]后缀长度区
//[3]后缀数据区
//[4]标志区，标志是否已经初始化过，如果已经初始化，则应该读取前后缀数据,3个
//[5]配对使能标志。1位
//[6]振动马达使能标志。1位 0x001A
//[6]低功耗标志。1位 0x001b
//如果未初始化，则将前后缀区全部清空。
...
u16 EE_ReadVariable(u16 VirtAddress, u16* Data)
{
  ...
  u32 Address = 0x0803C000, PageStartAddress = 0x0803C000;
...
static u16 EE_VerifyPageFullWriteVariable(u16 VirtAddress, u16 Data)
{
  FLASH_Status FlashStatus = FLASH_COMPLETE;
  u16 ValidPage = PAGE0;
  u32 Address = 0x0803C000, PageEndAddress = 0x0803C7FF;
...
{
  FLASH_Status FlashStatus = FLASH_COMPLETE;
  u32 NewPageAddress = 0x0803C7FF, OldPageAddress = 0x0803C000;
